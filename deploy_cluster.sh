...
TEASTORE_INSTANCES="${TEASTORE_INSTANCES:-4}"
LOCUST_INSTANCES="${LOCUST_INSTANCES:-2}"
LOCUST_INSTANCE_TYPE="${LOCUST_INSTANCE_TYPE:-c4.xlarge}"
...
aws cloudformation create-stack --stack-name teastorestack --template-body file://cloudformation_otel.yml \
